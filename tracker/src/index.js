export default {
	async fetch(request, env, ctx) {
		...
		const allowedOrigins = ['https://www.nikhilbadyal.com', 'https://nikhilbadyal.pages.dev'];
		...
		await env.RATE_LIMIT_KV.put(rateLimitKey, JSON.stringify({ count: (rateLimitData?.count || 0) + 1, timestamp: now }), { expirationTtl: rateLimitWindow / 1000 });
