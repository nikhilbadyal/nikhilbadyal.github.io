  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Logging Pipeline Setup with ELK Stack}
          {Set up a logging pipeline by configuring the ELK stack to ingest \textbf{600GB} of server logs per day from production servers. Pushed logs into Elasticsearch for efficient visualization and real-time search capabilities in Kibana.}
      \resumeItemListEnd
