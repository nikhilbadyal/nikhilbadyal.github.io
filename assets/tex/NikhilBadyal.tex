...
\section{Projects}\label{sec:projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Capstone: Movie Review Sentiment Analyzer}
        {An MLOps pipeline for a movie review sentiment analyzer using MLflow for experiment tracking, DVC for data versioning, and FastAPI for serving the model in production. Implemented model training, evaluation, and deployment processes, enabling real-time sentiment analysis on movie reviews. The system is designed for scalability and reproducibility. \href{https://github.com/nikhilbadyal/capstone}{[GitHub]}}
    \resumeSubItem{Personal Website Analytics}
      {Built a lightweight, serverless web analytics system using Cloudflare Workers and KV store to track page views, visitor insights with privacy focus and accepting and forwarding messages to me. \href{https://github.com/nikhilbadyal/nikhilbadyal.github.io}{[GitHub]}}
